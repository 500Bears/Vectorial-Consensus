...
**Live Demo:** [Link to live demo](https://your-username.github.io/your-repo-name/docs/AI_Mind_Palace_v5_The_Canonical_Edition.html)
...
The AI Mind Palace visualizes several key concepts in large language models:

*   **Vectorial Consensus:** The core of the AI's "thought process," where it reaches a definitive output by finding the highest mathematical agreement across its network.
*   **Latent Space:** The "starfield of concepts" where the AI's knowledge is stored as a geometric and numerical structure.
*   **Multi-Head Attention:** A parallel voting system where different "heads" focus on different aspects of the input:
    *   **Head 1 (Syntax):** Votes on grammatical correctness.
    *   **Head 2 (Semantics):** Votes on conceptual meaning.
    *   **Head 3 (Context):** Votes on what was just discussed.
    *   **Head 4 (Factual Retrieval):** Votes on core knowledge.
*   **Probability Collapse:** The final resolution of V-Consensus, where the AI selects the single best token to form the output.
